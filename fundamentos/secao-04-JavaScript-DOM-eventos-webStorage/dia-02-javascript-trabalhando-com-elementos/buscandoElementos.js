...
// const first = document.querySelector('#first-child-of-child')
// where.parentNode.style.color='blue';
// where.firstElementChild.innerText = 'Você se lembra dos vídeos da aula anterior? Eles ensinam como fazer isso.'
    ...
    firstChildOfChild.innerText = 'Você se lembra dos vídeos da aula anterior? Eles ensinam como fazer isso.';
